      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
        {agent.starting_prompts.map((prompt, index) => (
          <button
            ...
            disabled={!kubeReady}
            className={`group relative overflow-hidden rounded-lg p-3 text-left transition-all duration-200 ${
              kubeReady
          ...
          >
            ...
            <div className="relative">
              ...
              <p className={`text-xs leading-relaxed text-text-secondary transition-colors duration-200 ${
                kubeReady 
